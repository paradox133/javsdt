...
def process_youma(root_choose):
    ...
    dict_gen = {'中文字幕': '中文字幕', '无码流出': '无码流出',
                ...
                'ビッチ': 'bitch', '特典あり（AVベースボール）': '特典（AV棒球）', 'コミック雑誌': '漫画雑志', '時間停止': '时间停止','4K': '4K',
                ...
                '女裝人妖': '女装人妖', '內衣': '内衣', '猥褻穿著': '猥亵穿着', '兔女郎': '兔女郎', '貓耳女': '猫耳女', '女祭司': '女祭司',
                ...
                '放置': '放置', 'サンプル動画': '范例影片', 'サイコ・スリラー': '心理惊悚片', 'ラブコメ': '爱情喜剧', 'オタク': '御宅族','ハイビジョン':'高清','ディルド':'假阳具','ハイビジョン':'首次亮相'}
