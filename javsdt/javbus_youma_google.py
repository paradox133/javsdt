...
#  main开始
def process_youma(root_choose,config_path):
    ...
    for root, dirs, files in os.walk(root_choose):
        ...
        for jav in list_jav_videos:
            ...
            if not if_ID_exist(jav_raw_num,"DISTINCTID") or num_all_episodes>1:
                ...
                try:
                    ...
                    if bool_rename_mp4:
                        ...
                        if not exists(path_jav_new):
                            ...
                            #shutil.copyfile(path_jav, path_jav_new)
                        ...
                        if subt_file and bool_rename_subt:
                            ...
                            if path_subt != path_subt_new:
                                ...
                                # shutil.copyfile(path_subt, path_subt_new)
                        ...
                        # 不是独立的文件夹，建立独立的文件夹
                            ...
                            if not exists(path_jav_new):
                                ...
                                if subt_file:
                                    ...
                                    # shutil.copyfile(path_subt, root_separate_folder + sep + subt_file)
                    ...
                    if bool_classify and bool_classify_folder and jav_epi == num_all_episodes:    # 需要移动文件夹，且，是该影片的最后一集
                        ...
                        if not exists(root_now_new):
                            ...
                            for i in jav_files:
                                ...
                                # shutil.copyfile(root_now + sep + i, root_now_new + sep + i)
                            # 删除“旧房子”，这是javsdt唯一的删除操作，而且os.rmdir只能删除空文件夹
                            # os.rmdir(root_now) will have problem in the google drive
                            print('    >归类文件夹完成')
                        else:  # 用户已经有了这个车牌的文件夹
                            num_fail += 1
                ...
                print('>>Skip: Already existed in the DB and is a single file：ID: ' + jav_raw_num+ sep + 'file name: '+ jav_file)
